...
Sentinel BW does not connect to an external AI service. All "AI" functionality is rule-based inference computed from the CSV data at startup. The term AI refers to the automated analytical layer that processes raw data and surfaces actionable intelligence.
...
# username: doctor | password: doctor456
```
